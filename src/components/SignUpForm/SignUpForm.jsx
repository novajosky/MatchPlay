        ...
        return (
          <Card border="secondary">
            <Form autoComplete="off" onSubmit={this.handleSubmit}>
              ...
              <Form.Control size="sm" type="email" placeholder="Example: name@email.com" name="email" value={this.state.email} onChange={this.handleChange} required />
              <Form.Label>Password</Form.Label>
              <Form.Control size="sm" type="password" name="password" value={this.state.password} onChange={this.handleChange} required />
              <Form.Label>Confirm</Form.Label>
              <Form.Control size="sm" type="password" name="confirm" value={this.state.confirm} onChange={this.handleChange} required />
              <Form.Label>Age</Form.Label>
              <Form.Control size="sm" type="number" placeholder="Example: 33" name="age" value={this.state.age} onChange={this.handleChange} required />
              <Form.Label>Location</Form.Label>
              <Form.Control size="sm" type="text" placeholder="Example: Seattle, Washington" name="citystate" value={this.state.citystate} onChange={this.handleChange} required />
              <Form.Label>What is your Handicap?</Form.Label>
              <Form.Control size="sm" type="number" placeholder="Try to estimate otherwise, enter 30" name="handicap" value={this.state.handicap} onChange={this.handleChange} required />
              <Form.Label>Gender</Form.Label>
              <Form.Select size="sm" type="text" name="gender" value={this.state.gender} onChange={this.handleChange} required>
                <option value="Male">Male</option>
                <option value="Female">Female</option>
                <option value="Other">Other</option>
              </Form.Select>
              <Form.Label>Do you have a preferred gender you would like to play with?</Form.Label>
              <Form.Select size="sm" type="text" name="pfgender" value={this.state.pfgender} onChange={this.handleChange} required>
                <option value="Men">Men</option>
                <option value="Women">Women</option>
                <option value="Anyone">Anyone</option>
              </Form.Select>
              <Form.Label>Do you mind playing with people much older or younger than you?</Form.Label>
              <Form.Select size="sm" type="text" name="playage" value={this.state.playage} onChange={this.handleChange} required>
              ...
              <Form.Select size="sm" type="text" name="drinker" value={this.state.drinker} onChange={this.handleChange} required>
              ...
              <Form.Select size="sm" type="text" name="meticulous" value={this.state.meticulous} onChange={this.handleChange} required>
              ...
              <Form.Select size="sm" type="text" name="etiquette" value={this.state.etiquette} onChange={this.handleChange} required>
              ...
              <Form.Select size="sm" type="text" name="skillset" value={this.state.skillset} onChange={this.handleChange} required>
